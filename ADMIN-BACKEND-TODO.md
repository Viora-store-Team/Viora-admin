...
> ## ⚠️ تحديث 2026-08-23 — جزء من هذا الملف صار قديم
>
> وصلت من الباك إند مسارات **الدخول والنظرة العامة والمتاجر**، وانربطت
> فعلياً. أشكالها الحقيقية طلعت **مختلفة** عن المقترح المكتوب تحت — والواجهة
> اتعدّلت لتتبع الباك إند مش العكس.
>
> - **الحقيقة المفحوصة حيّاً:** [`API-STATUS.md`](API-STATUS.md) ← اقرأه أول
> - **لسا مطلوب:** المستخدمون · التصنيفات · البلاغات والتقييمات · المحتوى ·
>   التوصيل. أقسامهم تحت لسا صالحة.
> - **صار قديم:** قسم `Dashboard` (المسار صار `/admin/stats` بشكل مختلف
>   كلياً) وقسم `Stores` (ما في توثيق ولا إيقاف — قبول ورفض بس، والمالك
>   متداخل مش مفلطح).
>
> وكمان: خطوات الربط بالقسم ١ تحت اتغيّرت — التبديل صار **لكل مسار على حدة**
> مش علم عام. شوف `LIVE_PREFIXES` بـ `src/lib/admin/client.ts`.

هذا الملف مخرَج المرحلة الأولى من قسم الأدمن: الواجهات كلها مبنية، وهاي قائمة
الـAPIs المطلوبة + المشاكل اللي لازم تنحسم.
